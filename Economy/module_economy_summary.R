             ...
             div(class = "economy-panel-like",
                 ...
                 div(style = "font-size: 16px; margin-top: 8px;",
                     tags$ul(
                       ...
                       tags$li(tags$b("Real (constant) prices:"), " Real (constant) prices use the latest ",
                               tags$a(
                                 "gross domestic product GDP deflators",
                                 href = "https://www.gov.uk/government/collections/gdp-deflators-at-market-prices-and-money-gdp",
                                 target = "_blank"
                               ),
                               "to convert historic figures into prices representing prices in the most recent year."),
  ...
  moduleServer(id, function(input, output, session) {
    ...
    tiff_filtered <- main_tiff_data_long %>%
      filter(Measure == "23. Total income from farming (19-20-21)",
             Price == "Real (constant 2025)") %>% # FBI is real!!
