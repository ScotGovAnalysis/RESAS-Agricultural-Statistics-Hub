    ...
    mainPanel(
      ...
      fluidRow(class = "row-equal", 
       ...
       div(
          ...
          div(style = "padding: 0; margin-top: 10px;", fluidRow(column(
            width = 12, valueBoxEconomyUI(ns("tiff"))
          )))
        )
      ), #column(
        #width = 6,
     div(class = "col-flex",
      div(
          ...
          div(style = "padding: 0; margin-top: 10px;", fluidRow(column(
            width = 12, valueBoxEconomyUI(ns("fbs"))
          )))
        )
      )),
      ...
      fluidRow(column(
        width = 12, div(
          ...
          div(
            ...
            tags$ul(
              tags$li(
                tags$b("Farm Business income (FBI):"),
                " The total income available to all unpaid labour and their capital invested in the business."
              ),
              tags$li(
                tags$b("Total Income From Farming (TIFF):"),
                " The official measure of agricultural industry profit."
              ),
              tags$li(
